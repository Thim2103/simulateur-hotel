...
export default function AppSidebar() {
  ...
  return (
    <nav
      ...
      className="scroll-row flex gap-1 overflow-x-auto border-b border-slate-200/80 bg-white px-3 py-2 lg:sticky lg:top-14 lg:h-[calc(100vh-3.5rem)] lg:w-60 lg:shrink-0 lg:flex-col lg:overflow-y-auto lg:border-b-0 lg:border-r lg:p-3"
    >
