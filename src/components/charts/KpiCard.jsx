export default function KpiCard({ label, value, trend, loading = false }) {
  return (
    <div className="group rounded-2xl border border-[var(--ds-border)] bg-white p-4 shadow-[var(--ds-shadow-card)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[var(--ds-shadow-lift)] sm:p-5">
