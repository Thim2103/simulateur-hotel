...
// Multi-site staff management: global/local headcount and morale,
// transfers, training, promotions, and regional HR events -- all produced
// by lib/staffMulti/staffEngine.js (the same engine chainEngine.
// runChainCycle() runs once per chain cycle). Reuses the chain state from
// useChain() so this page reflects whichever hotels the chain currently has.
